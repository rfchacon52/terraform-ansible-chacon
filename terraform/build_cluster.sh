...
log_info "--- Starting EKS Cluster  build ---"
log_info "Target Cluster: ${EKS_CLUSTER_NAME}"
log_info ""

log_info ": Start ${EKS_CLUSTER_NAME} adding oids"
eksctl utils associate-iam-oidc-provider --cluster $EKS_CLUSTER_NAME --region $AWS_REGION --approve || log_error Failed 
